...
public class PetIdGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(PetIdGetHandlerTest.class);
    ...
    public void testPetsPetIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/pets/gBTNsdLuBGxhgDEg";
