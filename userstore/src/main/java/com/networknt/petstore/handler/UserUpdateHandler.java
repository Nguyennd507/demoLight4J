...
*/
public class UserUpdateHandler implements LightHttpHandler {
    ...
    //generate method from openAPI  -->     operationId: "updateUser"
    protected ResponseEntity updateUser(User user) throws ApiException {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        ResponseEntity<String> responseEntity = updateUser(user);
